...
codeunit 82566 "ADLSE CDM Util" // Refer Common Data Model https://docs.microsoft.com/en-us/common-data-model/sdk/overview
{
    ...
    var
        ...
        Imports: JsonArray;
        EntityName: Text;
        DescriptionTxt: Label 'Represents the table %1', Comment = '%1: Tablename';
    begin
        ...
        Definition.Add('description', StrSubstNo(DescriptionTxt, ADLSEUtil.GetTableName(TableID)));
    ...
    var
        ...
        EntityName: Text;
        ManifestNameTxt: Label '%1-manifest', Comment = '%1: Folder';
        EntityPathTxt: Label '%1.cdm.json/%1', Comment = '%1: EntityName';
        RootLocationTxt: Label '%1/%2/', Comment = '%1: Folder, %2: EntityName';
    begin
        Content.Add('jsonSchemaSemanticVersion', '1.0.0');
        ...
        if not ADLSEUtil.JsonTokenExistsWithValueInArray(Entities, 'entityName', EntityName) then begin
            ...
            Entity.Add('entityPath', StrSubstNo(EntityPathTxt, EntityName));

            DataPartitionPattern.Add('name', EntityName);
            DataPartitionPattern.Add('rootLocation', StrSubstNo(RootLocationTxt, Folder, EntityName));
