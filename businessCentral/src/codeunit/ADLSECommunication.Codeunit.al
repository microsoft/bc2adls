...
codeunit 82562 "ADLSE Communication"
{
    ...
    var
        ...
        ContainerUrlTok: Label 'https://%1.blob.core.windows.net/%2', Comment = '%1: Account name, %2: Container Name';
    ...
    begin
        ...
        exit(StrSubstNo(ContainerUrlTok, ADLSECredentials.GetStorageAccount(), DefaultContainerName));
    end;
    ...
    var
        ...
        FileIdentifer: Guid;
        DataBlobPathTxt: Label '/deltas/%1/%2.csv', Comment = '%1: EntityName, %2: FileId';
    begin
        if DataBlobPath <> '' then
            // already created blob
            exit;
        FileIdentifer := CreateGuid();
        DataBlobPath := StrSubstNo(DataBlobPathTxt, EntityName, ADLSEUtil.ToText(FileIdentifer));
