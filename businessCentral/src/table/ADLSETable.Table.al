...
table 82561 "ADLSE Table"
{
    ...
    var
        TableNotNormalErr: Label 'Table %1 is not a normal table.', Comment = '%1: TableCaption';
        TableExportingDataErr: Label 'Data is being executed for table %1. Please wait for the export to finish before making changes.', Comment = '%1: Table ID';
