...
--------------- | ---
[37](https://github.com/microsoft/bc2adls/pull/37) | Fix to errors when multiple entities were being consolidated using the same staging CDM folder. Each entity now has its own staging CDM folder so they can run in parallel without conflicts. 
